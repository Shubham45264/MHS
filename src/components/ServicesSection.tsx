...
const productServices = [
  { icon: ArrowUpFromLine, title: "Diesel Boom Lift", description: "High-reach diesel boom lifts for elevated work platforms at construction and industrial sites." },
...
const rentalServices = [
  { icon: ArrowUpFromLine, title: "Diesel Boom Lift", description: "Diesel-powered boom lifts available on daily, weekly, and monthly rental." },
